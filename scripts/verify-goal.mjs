...
const GATES = [
  ...
  { id: "browser-e2e-source-live", tier: "source-live-e2e", required: true, requireNoSkips: true, timeoutMs: 1_800_000, cmd: `powershell -NoProfile -ExecutionPolicy Bypass -File "${path.join(repoRoot, "scripts", "windows", "run-live-app-e2e.ps1")}" -LiveAdo`, description: "source Vite + daemon live E2E (real ADO reads)" },
