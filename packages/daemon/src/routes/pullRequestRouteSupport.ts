...
export const ProjectLinkPayloadSchema = z.object({
  projectLink: InlineProjectLinkSchema,
}).default({});

export const ProjectLinkPrInsightPreviewBodySchema = z.object({
  llmConfig: LlmConfigSchema,
  projectLink: InlineProjectLinkSchema,
}).default({});

export type AdoAuth = Awaited<ReturnType<typeof getAzureDevOpsAuth>>;
export type PullRequestProjectLink =
  NonNullable<Awaited<ReturnType<ProjectLinkStoreAdapter["getProjectLinkForRequest"]>>>;
