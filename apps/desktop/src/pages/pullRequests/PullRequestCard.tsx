...
import {
  ...
  ReviewRunPanel,
  StoredInsightPanel,
} from "./PullRequestInsightPanels.js";
  ...
  return (
    ...
    >
      ...
      {previewState.phase === "done" && (
        <InsightPreviewPanel previewState={previewState} insightTone={insightTone} />
      )}
      ...
      {isDone && <ReviewRunPanel result={qState.result} reviewTone={reviewTone} />}
