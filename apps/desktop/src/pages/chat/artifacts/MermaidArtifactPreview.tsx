      ...
      <div className="rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2" aria-live="polite">
        <div className="flex flex-wrap items-start justify-between gap-2">
          ...
          <button
            type="button"
            onClick={renderPreview}
            className="shrink-0 rounded-md border border-red-500/30 bg-[rgb(var(--app-surface))] px-2 py-1 text-[11px] font-medium text-[rgb(var(--app-danger))] transition hover:bg-red-500/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/25 active:translate-y-px"
          >
            Retry
          </button>
        </div>
