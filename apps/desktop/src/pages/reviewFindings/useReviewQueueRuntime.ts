...
export function useReviewQueueRuntime({
  ...
  return {
    ...
    pendingWriteBack: actions.pendingWriteBack,
    confirmDispositionWriteBack: actions.confirmDispositionWriteBack,
    keepDispositionLocal: actions.keepDispositionLocal,
