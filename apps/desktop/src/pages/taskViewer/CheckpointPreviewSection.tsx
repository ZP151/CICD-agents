        ...
        <div className="space-y-3">
          <div className="grid gap-3 text-sm sm:grid-cols-3">
            ...
            <div>
              ...
              <p className="mt-1 font-mono text-zinc-800">{preview.files.length}</p>
            </div>
            <div>
          ...
          {preview.statusLines.length > 0 && (
            <div>
              ...
              <pre className="max-h-28 overflow-auto rounded-md border border-zinc-200 bg-zinc-50 p-2 text-xs text-zinc-700">
          ...
          {preview.diffPreview && (
            <div>
              ...
              <pre className="max-h-72 overflow-auto rounded-md border border-zinc-200 bg-zinc-50 p-2 text-xs text-zinc-700">
                {preview.diffPreview}
              </pre>
            </div>
          )}
    ...
    <div>
      ...
      <div className="flex flex-wrap gap-1.5">
        {files.slice(0, 12).map((file) => (
          <span
            key={file}
            className="max-w-full truncate rounded-md border border-zinc-200 bg-zinc-50 px-2 py-1 font-mono text-xs text-zinc-700"
          >
            {file}
          </span>
        ))}
